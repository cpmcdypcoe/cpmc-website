...
import team from '../assets/Team/CPMC2k24.jpg'
import { Admiral, Advisors, commander, ViceAdmmiral, gunnersAndCummunity } from '../assets/Team/Data/2k25Data.js';
...
const Team2K25Page = () => {
  return (
    <>
      ...
      <Image alt="xyz" className={classes.image2k24} src={team} height={2000} />
        </div>
        ...
        <h1 className={classes.heading2}>
          OUR <span className={classes.red}> GUNNERS</span> & COMMUNITY <span className={classes.red}>MEMBERS</span>
        </h1>
        <div className={classes.team}>
          {gunnersAndCummunity.map((m, i) => (
            <Card m={m} key={i} />
          ))}
        </div>
      </div>
